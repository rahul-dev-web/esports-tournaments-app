...
class _ProfileSetupCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: const Color(0xFF9B6CFF).withValues(alpha: .35)),
        ),
        child: Row(
          children: [
            const Icon(Icons.gamepad_rounded, color: Color(0xFFBFA5FF)),
            const SizedBox(width: 12),
            const Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Complete your player profile', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800)),
                  SizedBox(height: 4),
                  Text('Set your in-game UID before creating teams or registering.', style: TextStyle(color: Colors.white60, fontSize: 12, height: 1.35)),
                ],
              ),
            ),
